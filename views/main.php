                    ...
                    <div class="center">
                        <div class="col-md-7 section-margin">
                            ...
                            <div id="about-popup" class="about-popup-options mfp-hide">
                                ...
                                <div class="team-image" style="background-image: url(img/abby.jpg)"></div>
                                <p class="team-name">Abby Turner</p>
                                <p class="team-profession">Chief Design Officer</p>
                            </div>
                    ...
                    <div class="center">
                        <div class="col-md-7 section-margin">
                            ...
                            <p class="italic">
                                ...
                                textures with the pre-existing environment made our wedding look effortless and chic instead of contrived
                                and posed."
                            </p>
                        ...
                        <div class="col-md-7 section-margin">
                            <div class="section-one">
                                ...
                                <div class="projects-list list-a">
                                    <ul>
                                        <li><a class="projects-link-1"><span>Full Event</span></a></li>
                                        <li><a class="projects-link-2"><span>Design</span></a></li>
                                        <li><a class="projects-link-3"><span>Logistics</span></a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="section-five p-h1 display-none">
                                <div class="border"></div>
                                <h1>PR/Marketing</h1>
                                <p>Building your brand into your event. Let’s showcase who you are to your clients at your event. Then, create a plan for following up, after the event.</p>
                                <nav class="navigation">
                                    <ul>
                                        <li class="close-projects"><a class="ion-close-round"></a></li>
                                    </ul>
                    ...
                    <div class="center">
                        <div class="col-md-7 section-margin">
                            ...
                            <p class="italic">
                                ...
                                communicate well, and have a good knowledge base of Montana vendors."
                            </p>
                    ...
                    <div class="center">
                        <div class="col-md-7 section-margin">
                            ...
                            <div class="row contact-info">
                                <a href="mailto:info@reedandlee.com">info@reedandlee.com</a><br/>
                                <a href="tel:406-924-9884">406.924.9884</a>
                            </div>
                        </div>
                    </div>
                </div>
